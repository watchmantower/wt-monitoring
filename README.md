...
`wt-warden` is a lightweight, high-performance server monitoring application written in Go. Its purpose is to help you track and analyze various metrics of your server, such as CPU usage, memory usage, disk space, and more. By running `wt-warden` on your server, you can receive real-time data about your server's health and performance.
...
To use `wt-warden`, visit [app.watchmantower.com](https://app.watchmantower.com), create a new account, and follow the on-screen instructions to set up your server monitoring. You can start monitoring your servers without the need for any complex configurations.
